...
## 🔄 5. Documentation Maintenance & Session Protocol

When updating or adding documentation:
1. Ensure all new architecture documents are placed in the appropriate `0X_*` subfolder under [`ARCHITECTURE/docs/`](file:///Abhi/Projects/SIH/ARCHITECTURE/docs).
2. Update the master index in [`ARCHITECTURE/docs/README.md`](file:///Abhi/Projects/SIH/ARCHITECTURE/docs/README.md).
3. Record all major changes, decisions, and review outcomes in [`ARCHITECTURE/docs/SESSION_LOGS.md`](file:///Abhi/Projects/SIH/ARCHITECTURE/docs/SESSION_LOGS.md).
